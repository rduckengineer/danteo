...
namespace danteo {
std::optional<State> StateGraph::landingStateFrom(State startingState, Event event) const {
    ...
    auto        foundTransition
        = std::find_if(possibleTransitions.begin(), possibleTransitions.end(),
